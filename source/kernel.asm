...
option_screen:
	...
	os_init_msg		db 'Welcome to LastOS', 0
	os_version_msg		db 'Version ', MIKEOS_VER, 0

	dialog_string_1		db 'Thanks for trying out LastOS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute LastOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of LastOS, and', 0
