; ==================================================================
; The Last Operating System bootloader
; Copyright (C) 2023 LastOS Developers -- see doc/LICENSE.TXT
;
...
OEMLabel		db "LASTBOOT"	; Disk label
...
VolumeLabel		db "LASTOS     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"	; LastOS kernel filename
