; ------------------------------------------------------------------
; Simple file manager for LastOS: copy, delete and rename files
; ------------------------------------------------------------------
	...
	; This is the point used by the disk buffer in the LastOS kernel
...
.draw_background:
	...
	.title_msg		db 'LastOS File Manager', 0
